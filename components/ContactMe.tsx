    ...
    max-w-7xl px-10 justify-evenly mx-auto items-center'>
        ...
        <div className='flex flex-col space-y-10 mt-28'>
            <h4 className='text-xl sm:text-2xl font-semibold text-center'>
                ...
                <span className='decoration-[#64ffda]/50 underline block sm:inline'>Let's Talk</span>
            </h4>
            ...
            <form
             ...
             >
                ...
                <button className='bg-[#64ffda] py-5 px-10 rounded-md text-black font-bold text-lg tracking-[3px]'>SUBMIT</button>
            </form>
